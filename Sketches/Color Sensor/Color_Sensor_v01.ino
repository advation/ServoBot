// Color Sensor Sketch
// Source: http://www.instructables.com/id/Using-an-RGB-LED-to-Detect-Colours/
// 
// Update: 04-14-2015
// By: Nick Raymond
// Raw code - still needs to be simplified for Robot Workshop, would like to initialize colors with paint cards from hardware store
// In future sketch, teach the robot red, green, blue colors first then have robot look for colors
//
// Hook up Red to pin 2, Green to pin 3, Blue to pin 4
// CdS sensor with 100k resistor voltage divider, middle to pin A0
...
void setup(){
  ...
  digitalWrite(2, HIGH); //turn off the Red LED
  digitalWrite(3, HIGH); //turn off the Green LED
  digitalWrite(4, HIGH); //turn off the Blue LED
